...
```
Еще есть вариант разделить HTML разметку с JS кодом по разным файлам - для этого я сделал в одной директории файл `index.html` и `hello.js`. Далее нужно добавить в тег `script` атрибут `src` и в нем прописать путь до JavaScript файла:
```HTML
<html>
  <script src="hello.js"></script>
</html>
```
Теперь я хочу добавить код JS в файл `hello.js`:
```JavaScript
console.log("Hello world!");
```
Когда я загружу страницу в консоли появится сообщение с приветствием.
Могу добавить вместо консольного вывода и алерт:
```JavaScript
alert("Hello world!");
```
